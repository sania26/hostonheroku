...
<button class="btn btn-primary btn-default align-right ms-auto">Change</button>
										</div>
									...
									<div class="card-body">
                                           ...
                                           @foreach($company as $comp)
												<div class="form-group">
                                                    ...
                                                    <div id="exampleFormControlInput1">{{$comp->company_name}}</div>
												</div>

                                                <div class="form-group">
													<label for="exampleFormControlInput1">First Name</label>
													<div id="exampleFormControlInput1">{{$comp->firstname}}</div>
                                                </div>
                                                <div class="form-group">
													<label for="exampleFormControlInput1">Last Name</label>
													<div>{{$comp->lastname}}</div>
                                                </div>
                                                <div class="form-group">
												...
												<div class="form-group">
													<label for="exampleFormControlPassword">Tel</label>
                                                    <div>{{$comp->tel}}</div>
                                                </div>
                                                <div class="form-group">
													<label for="exampleFormControlPassword">Email1</label>
                                                    <div>{{$comp->email1}}</div>
                                                </div>
                                                <div class="form-group">
													<label for="exampleFormControlPassword">Email2</label>
                                                    <div>{{$comp->email2}}</div>
                                                </div>
                                                <div class="form-group">
													<label for="exampleFormControlPassword">P.O.Box</label>
                                                    <div>{{$comp->pobox}}</div>
                                                </div>
                                            ...
                                            @endforeach
                            <div>MAIL HOST: {{print_r($host)}}</div>
										</div>
									</div>
